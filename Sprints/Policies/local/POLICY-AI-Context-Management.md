...
2. Read MASTER-SPRINT.md             # Current state
3. Read Logs/MASTER-LOG.md           # Recent session notes
4. Read Logs/EXCEPTIONS-LOG.md       # Pending issues
5. Identify active sprint from MASTER-SPRINT.md
6. Read active sprint's SPRINT-PLAN.md
7. Read active sprint's SPRINT-LOG.md
8. Resume from last completed task
```
